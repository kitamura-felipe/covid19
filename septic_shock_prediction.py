...
def septic_shock_prediction(df_final):
    ...
    save_path_2x2 = os.path.join(BASE_DIR, "desfechos_intermediarios", "septic_shock_model_2x2.tiff")
    plot_results_2x2(summaries, save_path_2x2, fformat="tiff")

    save_path_1x2 = os.path.join(BASE_DIR, "desfechos_intermediarios", "septic_shock_model_1x2.tiff")
    metrics_summary = plot_results_1x2(summaries, save_path_1x2, fformat="tiff")

    save_path_shap = os.path.join(BASE_DIR, "desfechos_intermediarios", "septic_shock_shap.tiff")
    shap_values_plot = plot_shap_values(X_test, summaries, [f[1] for f in features_display_names], save_path_shap, fformat="tiff")

    save_path_sens_spec = os.path.join(BASE_DIR, "desfechos_intermediarios", "septic_shock_sens_spec.tiff")
    plot_sensitivity_specificity_vs_threshold(summaries, save_path_sens_spec, fformat="tiff")

    save_report = os.path.join(BASE_DIR, "desfechos_intermediarios", "septic_shock_report.txt")
    reports = generate_experiment_report(
        "Septic Shock", target, df_split, df_final, features, metrics_summary,
    ...
    save_path_survival = os.path.join(BASE_DIR, "desfechos_intermediarios", "septic_shock_survival.tiff")
    plot_survival(df_test, features, summaries, save_path_survival, fformat="tiff")


def septic_shock_prediction_loio(df_final, institution):
    ...
    save_path_2x2 = os.path.join(BASE_DIR, "desfechos_intermediarios", "LOIO", f"{institution[0]}_septic_shock_model_2x2.tiff")
    plot_results_2x2(summaries, save_path_2x2, fformat="tiff")

    save_path_1x2 = os.path.join(BASE_DIR, "desfechos_intermediarios", "LOIO", f"{institution[0]}_septic_shock_model_1x2.tiff")
    metrics_summary = plot_results_1x2(summaries, save_path_1x2, fformat="tiff")

    save_path_shap = os.path.join(BASE_DIR, "desfechos_intermediarios", "LOIO", f"{institution[0]}_septic_shock_shap.tiff")
    shap_values_plot = plot_shap_values(X_test, summaries, [f[1] for f in features_display_names], save_path_shap, fformat="tiff")

    save_path_sens_spec = os.path.join(BASE_DIR, "desfechos_intermediarios", "LOIO", f"{institution[0]}_septic_shock_sens_spec.tiff")
    plot_sensitivity_specificity_vs_threshold(summaries, save_path_sens_spec, fformat="tiff")

    save_report = os.path.join(BASE_DIR, "desfechos_intermediarios", "LOIO", f"{institution[0]}_septic_shock_report.txt")
    reports = generate_experiment_report(
        "Septic Shock", target, df_split, df_final, features, metrics_summary,
        train_valid_records, test_records, save_report
    )
    ...
    # save_path_survival = os.path.join(BASE_DIR, "desfechos_intermediarios", "LOIO", f"{institution[0]}_septic_shock_survival.tiff")
    # plot_survival(df_test, features, summaries, save_path_survival, fformat="tiff")


if __name__ == "__main__":
    df_final = pd.read_csv(DATA_FPATH)
    septic_shock_prediction(df_final)
